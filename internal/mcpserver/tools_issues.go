...
func createIssueHandler(mgr IssueManager) func(context.Context, *mcp.CallToolRequest, CreateIssueToolInput) (*mcp.CallToolResult, any, error) {
...
func updateIssueHandler(mgr IssueManager) func(context.Context, *mcp.CallToolRequest, UpdateIssueToolInput) (*mcp.CallToolResult, any, error) {
...
type AddIssueAttachmentInput struct {
	...
	Content string `json:"content" jsonschema:"Attachment content (required)"`
}
...
func addIssueAttachmentHandler(store core.Store) func(context.Context, *mcp.CallToolRequest, AddIssueAttachmentInput) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, in AddIssueAttachmentInput) (*mcp.CallToolResult, any, error) {
		...
		if err := store.SaveIssueAttachment(issue.ID, strings.TrimSpace(in.Path), strings.TrimSpace(in.Content)); err != nil {
